package com.ding.voicecyber.certificateview.ShowPhoto;
...
public class DragPhotoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPhotoViews.setOnTapListener(new DragPhotoView.OnTapListener() {
            @Override
        ...
        mPhotoViews.setOnExitListener(new DragPhotoView.OnExitListener() {
        ...
        mViewPager.setAdapter(new PagerAdapter() {
            ...
            public Object instantiateItem(ViewGroup container, int position) {
                ...
                container.addView(mPhotoViews);
                return mPhotoViews;
            }

            @Override
            public void destroyItem(ViewGroup container, int position, Object object) {
                container.removeView(mPhotoViews);
            }
        ...
        mViewPager.getViewTreeObserver()
                .addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    public void onGlobalLayout() {
                        ...
                        final DragPhotoView photoView = mPhotoViews;
                        ...
                        mPhotoViews.setMinScale(mScaleX);
                    }
                });
    }
